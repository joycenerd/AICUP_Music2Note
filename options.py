...
ROOTPATH = "/Users/joycechin/AICUP_Music2Note/Data"

parser=argparse.ArgumentParser()
parser.add_argument('--data_root',type=str,default=Path(ROOTPATH).joinpath('MIR'),help='Your dataset root directory')
